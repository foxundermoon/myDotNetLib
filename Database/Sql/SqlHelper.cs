...
namespace FoxundermoonLib.Database.Sql
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string connectionString = System.Configuration.ConfigurationSettings.AppSettings["SqlConnectionString"].ToString().Trim();
        ...
        {
            return ExecteNonQuery(connectionString, CommandType.Text, cmdText, null);
        }
        ...
        {
            return ExecteNonQuery(connectionString, CommandType.Text, sql, ps);
        }
    }
